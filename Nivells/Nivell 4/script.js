document.addEventListener("DOMContentLoaded", () => {
  ...
  const preguntesNivell1 = [
            {
                pregunta: "Què s'observa en arribar a la clariana dalt de tot?",
                opcions: [
                    { text: "A) Una cova fosca i tancada.", correcta: false, tts: "Opció A: Una cova fosca i tancada." },
                    { text: "B) Els arbres deixen pas a un cel infinit.", correcta: true, tts: "Opció B: Els arbres deixen pas a un cel infinit." },
                    { text: "C) Un gran llac ple de peixos.", correcta: false, tts: "Opció C: Un gran llac ple de peixos." }
                ]
            },
            {
                pregunta: "Com es descriu la sensació del vent a les orelles?",
                opcions: [
                    { text: "A) Com una carícia freda i constant que xiula.", correcta: true, tts: "Opció A: Com una carícia freda i constant que xiula." },
                    { text: "B) Com una escaldor forta que crema.", correcta: false, tts: "Opció B: Com una escaldor forta que crema." },
                    { text: "C) No es nota gens de vent, fa molta calor.", correcta: false, tts: "Opció C: No es nota gens de vent, fa molta calor." }
                ]
            },
            {
                pregunta: "A què es compara l'aire pur d'aquest nivell?",
                opcions: [
                    { text: "A) Al fum de les xemeneies de la ciutat.", correcta: false, tts: "Opció A: Al fum de les xemeneies de la ciutat." },
                    { text: "B) A la humitat de la vora del riu.", correcta: false, tts: "Opció B: A la humitat de la vora del riu." },
                    { text: "C) A l'aire pur de la llibertat.", correcta: true, tts: "Opció C: A l'aire pur de la llibertat." }
                ]
            }
        ];
