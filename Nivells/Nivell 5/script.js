document.addEventListener("DOMContentLoaded", () => {
  ...
  {
    "pregunta": "Què s'observa des del cim de la muntanya?",
    "opcions": [
      { "text": "A) Una vista panoràmica espectacular de les valls i els boscos.", "correcta": true, "tts": "Opció A: Una vista panoràmica espectacular de les valls i els boscos." },
      { "text": "B) Una paret de roca que tapa tota la llum.", "correcta": false, "tts": "Opció B: Una paret de roca que tapa tota la llum." },
      { "text": "C) El fons d'un pou molt profund.", "correcta": false, "tts": "Opció C: El fons d'un pou molt profund." }
    ]
  },
  {
    "pregunta": "Com es descriu l'ambient acústic al punt més alt?",
    "opcions": [
      { "text": "A) Es sents una música de festa molt forta.", "correcta": false, "tts": "Opció A: Es sents una música de festa molt forta." },
      { "text": "B) És un silenci majestuós, només trencat per la respiració.", "correcta": true, "tts": "Opció B: És un silenci majestuós, només trencat per la respiració." },
      { "text": "C) S'escolta el soroll dels cotxes de la ciutat.", "correcta": false, "tts": "Opció C: S'escolta el soroll dels cotxes de la ciutat." }
    ]
  },
  {
    "pregunta": "De quin color es veu l'horitzó al fons de tot?",
    "opcions": [
      { "text": "A) Completament negre de tempesta.", "correcta": false, "tts": "Opció A: Completament negre de tempesta." },
      { "text": "B) Color verd fluorescent.", "correcta": false, "tts": "Opció B: Color verd fluorescent." },
      { "text": "C) Daurat pel sol.", "correcta": true, "tts": "Opció C: Daurat pel sol." }
    ]
  }
];
        ...
        if (opcio.correcta) {
          ...
          parlar("Correcte.", () => {
            parlar("Carregant el següent nivell.", () => {
              window.location.href = "../Nivell 6/index.html";
            });
          });
        } else {
